...
## The Ora Language
This section outlines the grammar and syntax of Ora. 
...
<Example>`3 + 2` reduces to `5`.</Example>

<Example>`-4 + 1` reduces to `-3`.</Example>

<Example>`2.8 + 1.1` reduces to `3.9`.</Example>

<Example>
Adding a floating point number and an integer results in a floating point number.

`5.0 + 1` reduces to `6.0`.
...
<Example>`8 - 6` reduces to `2`.</Example>

<Example>`7 - 10` reduces to `-3`.</Example>
...
<Example>`9 * 7` reduces to `63`.</Example>
